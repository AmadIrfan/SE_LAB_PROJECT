            ...
            children: [
              ...
              ListTile(
                leading: CircleAvatar(
                  ...
                  child: userProvider.getPublisher!.profileImage
                          .toString()
                          .isEmpty
                      ? const SizedBox()
                      : Image.network(
                          userProvider.getPublisher!.profileImage.toString(),
                        ),
                ),
                title: Text(
                  // '',
                  userProvider.getPublisher!.name.toString(),
                ...
                subtitle: Text(
                  userProvider.getPublisher!.email.toString(),
                  style: const TextStyle(
